  ...
  return (
    ...
    return (
      ...
      <div className="flex gap-4 mt-4 no-print">
        ...
        <button onClick={() => navigate("/quotation/hh", { state: { editData: formData } })} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
          Edit PO
        </button>
